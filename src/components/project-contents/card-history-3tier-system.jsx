        ...
        <div className="project-detail-container">
            ...
            <Section title={'INDEX'}>
                <Item subTitle={'Docker 컨테이너 기반 3-tier 아키텍처 구현'}>
                    <p>1. 이중 부하분산 구조 (Master Nginx → Worker Nginx → WAS) 설계 및 구현</p>
                    <p>2. Redis 기반 세션 공유를 통한 WAS 간 상태 동기화 및 고가용성 확보</p>
                    <p>3. MySQL Router + Cluster를 활용한 읽기/쓰기 분리 및 데이터베이스 부하 분산</p>
                    <p>4. Java Servlet 필터 체인을 통한 세션 관리, 인증, 인코딩 처리 자동화</p>
                </Item>
            </Section>
