...
return (
        <div className="project-detail-container">
                ...
                <Section title={'INTRODUCE'}>
                    ...
                    <Item subTitle={'SpringBoot를 활용한 DBConnection 모듈화'}>
                        <p>
                            기존의 DB의 연결과 쿼리 요청 등을 JAVA 파일에 하드 코딩하여 사용한 것과 달리 'xml' 파일로 분리하여 유지보수성을 높힌다.
                        </p>
                        <p>
                            'xml'에 동일한 테이블에 관련된 쿼리문을 응집시켜 둠으로 써 코드의 가독성을 높히고, 각 Mapping으로 연결하였다.
                        </p>
                        <p>
